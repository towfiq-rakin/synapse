...
## Corpus Check
- 253 files · ~175,833 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1800 nodes · 3242 edges · 103 communities (93 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `26266a96`
...
Cohesion: 0.07
Nodes (21): useIsMobile(), AppShellProps, DesktopSidebarControl(), SidebarPanel, NavItemButton(), Sheet(), SheetContent(), SheetDescription() (+13 more)
...
Cohesion: 0.09
Nodes (23): buildAbsoluteUrl(), NoteGetResponse, PublicProfileResponse, PublishResponse, ShareNoteDialog(), ShareNoteDialogProps, ShareState, visibilityOptions (+15 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (20): AppSidebar(), AppSidebarProps, filterNotesByTitle(), normalizeSearchTerm(), NoteSummary, primarySidebarItems, DropdownMenu(), DropdownMenuContent() (+12 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (16): buildTree(), compareBySort(), ExplorerFolder, ExplorerNote, ExplorerPayload, ExplorerSidebarProps, FolderOption, SortMode (+8 more)
...
Cohesion: 0.1
Nodes (23): useTiptapEditor(), isListActive(), LIST_SHORTCUT_KEYS, listIcons, listLabels, ListType, useList(), UseListConfig (+15 more)

### Community 17 - "Community 17"
Cohesion: 0.17
Nodes (25): canToggleBlockquote(), shouldShowButton(), toggleBlockquote(), useBlockquote(), UseBlockquoteConfig, canToggle(), shouldShowButton(), toggleCodeBlock() (+17 more)
...
Cohesion: 0.13
Nodes (13): enhanceMermaidCodeBlocks(), findMermaidCodeBlocks(), getMermaid(), renderMermaidInHtmlString(), renderMermaidSource(), PublicNoteContentProps, createPreviewWidget(), getMermaidNodeAt() (+5 more)
...
Cohesion: 0.2
Nodes (12): connectToDatabase(), EditorNote, NoteEditorPage(), NotePageProps, ensureProfileIndexNote(), ensurePublishedProfileIndexNote(), findProfileIndexNote(), ProfileIndexNoteSummary (+4 more)
...
Cohesion: 0.14
Nodes (11): AppOptionsPopover(), AppOptionsPopoverProps, FolderItem, AlertDialog(), AlertDialogAction(), AlertDialogCancel(), AlertDialogContent(), AlertDialogDescription() (+3 more)

### Community 32 - "Community 32"
Cohesion: 0.17
Nodes (16): INote, isPublishVisibility(), PATCH(), PublishableNote, PublishBody, RouteContext, buildPublishedSnapshot(), clearPublishedFields() (+8 more)

### Community 33 - "Community 33"
Cohesion: 0.18
Nodes (17): buildBaseUsername(), buildDisplayName(), ClerkUser, ensureLocalUserRecord(), generateUniqueUsername(), buildPrivateNoteHref(), buildUserFolderHref(), buildUserNoteHref() (+9 more)

### Community 34 - "Community 34"
Cohesion: 0.12
Nodes (12): getSelectedNodesOfType(), handleImageUpload(), isAllowedUri(), MAC_SYMBOLS, ProtocolConfig, ProtocolOptions, sanitizeUrl(), SR_ONLY (+4 more)
...
Cohesion: 0.25
Nodes (13): GET(), DELETE(), GET(), normalizeFileName(), normalizeFolderId(), normalizeSlug(), normalizeTags(), normalizeTitle() (+5 more)

### Community 37 - "Community 37"
Cohesion: 0.16
Nodes (16): POST(), createFolderForUser(), ExplorerFolder, ExplorerNote, ExplorerPayload, ExplorerUser, getExplorerUser(), LeanFolder (+8 more)

### Community 38 - "Community 38"
Cohesion: 0.16
Nodes (17): buildFolderSegmentsById(), buildNoteShareState(), buildPublishedNoteUrl(), buildShareUrl(), NoteShareState, PublicLinkableNote, StringLikeId, toId() (+9 more)

### Community 39 - "Community 39"
Cohesion: 0.11
Nodes (17): 13.1 Known Risks, 13.2 Identified Technical Debt, 13. Architecture Risks & Technical Debt, 2.1 Driving Quality Attributes, 2.2 Architectural Constraints, 2. Architectural Goals & Constraints, 3.1 External System Responsibilities, 3. System Context View (+9 more)
...
Cohesion: 0.15
Nodes (9): HeadingDropdownMenu, HeadingDropdownMenuProps, getActiveHeadingLevel(), useHeadingDropdownMenu(), UseHeadingDropdownMenuConfig, ChevronDownIcon, SvgProps, HeadingIcon (+1 more)
...
Cohesion: 0.21
Nodes (11): decorateLegacyHtml(), getMarkdownSource(), normalizeLineEndings(), PublicNoteTocItem, renderMarkdownHtml(), renderPublicNote(), RenderPublicNoteInput, RenderPublicNoteResult (+3 more)
...
Cohesion: 0.22
Nodes (11): BreakpointMode, useIsBreakpoint(), canInsertImage(), insertImage(), isImageActive(), shouldShowButton(), useImageUpload(), UseImageUploadConfig (+3 more)

### Community 51 - "Community 51"
Cohesion: 0.22
Nodes (12): canColorHighlight(), getHighlightColorValue(), HIGHLIGHT_COLORS, HighlightColor, HighlightMode, isColorHighlightActive(), removeHighlight(), shouldShowButton() (+4 more)
...
Cohesion: 0.22
Nodes (9): renderPrintableNoteHtml(), decodeHtmlAttribute(), getImageTagAttribute(), getLeadingSpaces(), isListItemLine(), MARKDOWN_ONLY_PATTERNS, normalizeEmbeddedImageTags(), normalizeListAttachedCodeFences() (+1 more)
...
Cohesion: 0.36
Nodes (7): IUser, userSchema, ClerkIssue, getClerkIssues(), getUsernameErrorResponse(), normalizeUsername(), PATCH()
...
- **Why does `getAuthenticatedUserId()` connect `Community 0` to `Community 32`, `Community 33`, `Community 66`, `Community 36`, `Community 37`, `Community 46`, `Community 15`, `Community 23`, `Community 28`, `Community 61`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 28` to `Community 32`, `Community 33`, `Community 66`, `Community 0`, `Community 36`, `Community 37`, `Community 46`, `Community 15`, `Community 23`, `Community 61`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `POST()` connect `Community 15` to `Community 0`, `Community 28`?**
